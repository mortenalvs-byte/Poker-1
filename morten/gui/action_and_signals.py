...
from morten.gui.pandas_model import PandasModel
from morten.gui.plots.bar_plotter_2 import BarPlotter2
from morten.gui.plots.curve_plot import CurvePlot
from morten.gui.plots.funds_change_plot import FundsChangePlot
from morten.gui.plots.funds_plotter import FundsPlotter
from morten.gui.plots.histogram_equity import HistogramEquityWinLoss
from morten.gui.plots.pie_plotter import PiePlotter
from morten.gui.plots.scatter_plot import ScatterPlot
from morten.tools.helper import COMPUTER_NAME, open_payment_link

if not (platform == "linux" or platform == "linux2"):  # pylint: disable=consider-using-in
    matplotlib.use('Qt5Agg')
from PyQt6.QtCore import *
from morten.scraper.table_setup_actions_and_signals import TableSetupActionAndSignals
from morten.gui.gui_launcher import TableSetupForm, GeneticAlgo, SetupForm, StrategyEditorForm, AnalyserForm
from morten.tools.mongo_manager import MongoManager

try:
    from morten.tools.vbox_manager import VirtualBoxController
except ImportError:
    VirtualBoxController = None
from PyQt6.QtWidgets import QMessageBox
import webbrowser
from morten.decisionmaker.genetic_algorithm import *  # pylint: disable=wildcard-import
import os
import logging
...
class UIActionAndSignals(QObject):  # pylint: disable=undefined-variable
    ...
    def open_help(self):
        url = "https://github.com/mortenalvs-byte/morten"
