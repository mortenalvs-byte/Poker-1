...
from morten.scraper.table_scraper_nn import TRAIN_FOLDER
from morten.tools.helper import COMPUTER_NAME, get_config, get_dir
from morten.tools.mongo_manager import MongoManager
from morten.tools.screen_operations import get_table_template_image, get_ocr_float, take_screenshot, \
...
class TableSetupActionAndSignals(QObject):
    ...
    def train_model(self):
        ...
        from morten.scraper.table_scraper_nn import CardNeuralNetwork
        n = CardNeuralNetwork()
    ...
    def test_all(self):
        """Test table button"""
        self.table_name = self.ui.table_name.currentText()
        from morten.scraper.table_scraper import TableScraper
        table_dict = mongo.get_table(table_name=self.table_name)
