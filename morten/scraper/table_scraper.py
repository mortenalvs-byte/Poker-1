...
from morten.scraper.table_scraper_nn import predict
from morten.scraper.table_setup_actions_and_signals import CARD_SUITES, CARD_VALUES
from morten.tools.helper import get_dir
from morten.tools.screen_operations import take_screenshot, crop_screenshot_with_topleft_corner, \
